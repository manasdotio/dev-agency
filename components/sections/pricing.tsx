      ...
      <div className="w-layout-blockcontainer container-main w-container">
        <div className="w-layout-grid grid-12">
          <h2 className="pricing-heading-h2">
            Pick the plan that fits your <span className="text-span-6">start-up</span>
          </h2>
        </div>

        <div className="w-layout-grid pricing-grid">
          <div data-w-id="1669cd86-8bd6-82a8-f5ef-dd6aecda9ed8" className="plan-1">
            <div className="w-layout-grid plan-wrapper">
              <div className="div-block-36">
                ...
                <div className="plan-descp">
                  For companies who need design <br />
              ...
              <div className="feature-sec">
                ...
                <ul role="list" className="feature-list w-list-unstyled">
                  {[
                    ...
                    <li key={feature} className="list-item-8">
                      <img src="/images/69afb0934a0a9b77eaf024bd_checked.svg" loading="lazy" alt="" className="image-4" />
          ...
          <div data-w-id="6cd966a7-b9fb-ce9d-e067-0ef5ced882b0" className="div-block-34">
            <div className="w-layout-grid grid-15">
              <div className="div-block-37">
                ...
                <div className="text-block-25">2x the speed. Great for an MVP, Web App or complex problem</div>
                ...
                <div className="points">
                  <ul role="list" className="list-3 w-list-unstyled">
                    {[
                      ...
                      <li key={feature} className="list-item-7">
                        <img src="/images/69afb0934a0a9b77eaf024be_light-checked.svg" loading="lazy" alt="" />
